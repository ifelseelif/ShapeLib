[![dotnet build and test](https://github.com/ifelseelif/ShapeLib/actions/workflows/dotnet-test.yml/badge.svg)](https://github.com/ifelseelif/ShapeLib/actions/workflows/dotnet-test.yml)
